...
Make sure to include the icon library script. For more details, see the [installation instructions](/docs/2.1/javascript).
...
Using the built-in icon is fully optional. If you choose not to use it and prefer other icon libraries instead, make sure to suppress errors to avoid issues, etc.
